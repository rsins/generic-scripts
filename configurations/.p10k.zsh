# Generated by Powerlevel10k configuration wizard on 2021-09-03 at 12:52 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    shell_level             # Current shell level if a shell is created inside another shell
    time                    # current time
  ...
  function prompt_machine_name() {
     p10k segment -f 208 -t "`uname -n`"
  }
